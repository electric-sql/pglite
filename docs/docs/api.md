...
- `pgliteWasmModule?: WebAssembly.Module`<br />
  A precompiled pglite WASM module to use instead of downloading the default version, or when using a bundler that either can, or requires, loading the WASM module with a ESM import.
- `initdbWasmModule?: WebAssembly.Module`<br />
  A precompiled initdb WASM module to use instead of downloading the default version, or when using a bundler that either can, or requires, loading the WASM module with a ESM import.
