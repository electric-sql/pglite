    ...
    build: {
        ...
        rollupOptions: {
            external: __spreadArray(__spreadArray(__spreadArray([
                "react/jsx-runtime"
            ], Object.keys(package_json_1.default.dependencies), true), Object.keys(package_json_1.default.peerDependencies), true), Object.keys(package_json_1.default.devDependencies), true),
        },
    },
});
